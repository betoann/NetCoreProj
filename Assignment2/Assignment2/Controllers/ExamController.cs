...
namespace Assignment2.Controllers
{
    public class ExamController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Exam.Include(e => e.Student).Include(e => e.Subject);
        ...
        public async Task<IActionResult> Create([Bind("ExamId,Score,StudentId,SubjectId")] Exam exam)
        {
            ...
            ViewData["SubjectId"] = new SelectList(_context.Subject, "SubjectId", "SubjectId", exam.SubjectId);
            return View(exam);
        }
